...
class hotspot extends \core_form\dynamic_form {
    ...
    public function definition() {
        ...
        $mform->addElement('editor', 'content', get_string('content', 'local_ivannotation'), null, [
            'maxfiles' => -1,
            'maxbytes' => 0,
            'trusttext' => true,
            'noclean' => true,
        ...
        $mform->addElement(
            ...
            'usemodal',
            '',
            get_string('usemodal', 'local_ivannotation'),
            null,
            [0, 1],
        );
        ...
        $mform->addElement(
            ...
            'openbydefault',
            '',
            get_string('openbydefault', 'local_ivannotation'),
            null,
            [0, 1],
        );
        ...
        $mform->addElement(
            'text',
            'color',
            get_string('color', 'local_ivannotation') .
