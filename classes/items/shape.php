...
class shape extends \core_form\dynamic_form {
    ...
    public function definition() {
        ...
        $mform->addElement('select', 'shape', get_string('shape', 'local_ivannotation'), [
            'rectangle' => get_string('rectangle', 'local_ivannotation'),
            'circle' => get_string('circle', 'local_ivannotation'),
        ]);
        ...
        $mform->addElement(
            'text',
            'timestamp',
            get_string('gototimestamp', 'local_ivannotation'),
            [
                'size' => 100,
        ...
        $mform->addElement('text', 'opacity', get_string('opacity', 'local_ivannotation'), ['size' => 100]);
